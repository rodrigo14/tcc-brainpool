...
Assumindo que o percuso aleatório \ref{eq:walk} definido no algoritmo produz termos aleatórios, o algoritmo resolve o ECDLP com operação de ordem $O(\sqrt{n})$. \cite{Pollard:1978}
