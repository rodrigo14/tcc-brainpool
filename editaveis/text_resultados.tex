...
Com esse sistema, ao fazer \(ln(Y_B) - ln(Y_A)\), obtem-se o valor de \(b\), e em seguida o valor de \(ln(a)\). Dessa forma, as equações que relacionam o tamanho da curva em \textit{bits} ao tempo necessário em segundos para ``quebrá-la'' foram as seguintes
\begin{itemize}
...
2m47s            & 5m20s            & 5m35s            & 6m32s            \\ \hline
8m35s            & 3m16s            & 7m14s            & 2m44s            \\ \hline
7m12s            & 5m13s            & 2m37s            & 3m23s            \\ \hline
11m25s           & 3m26s            & 5m55s            & 4m55s            \\ \hline
3m07s            & 2m30s            & 3m42s            & 4m01s            \\ \hline
3m13s            & 1m37s            & 4m01s            & 6m44s            \\ \hline
1m42s            & 6m36s            & 3m41s            & 2m22s            \\ \hline
8m31s            & 4m25s            & 1m16s            & 4m39s            \\ \hline
\end{tabular}
...
média aritmética               & 5m49s            & 4m03s            & 4m15s            & 4m25s            \\ \hline
variância                      & 45471.14$s^2$    & 9779.41$s^2$     & 13218.125$s^2$   & 9401.07$s^2$     \\ \hline
desvio-padrão                  & 213.23s          & 98.89s           & 114.97s          & 96.96s           \\ \hline
\end{tabular}
