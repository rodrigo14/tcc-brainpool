...
Durante a execução desse algoritmo, o problema de memóra RAM tornou-se evidente, pois, apesar de utilizar uma propriedade distintiva para armazenar os pontos, 16GB de memória se tornavam insuficientes após aproximadamente 25 horas de execução do algoritmo, resultando em erro de memória ao tentar ``quebrar'' uma curva de 66 bits.
