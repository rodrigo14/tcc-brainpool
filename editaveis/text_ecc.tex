...
Por exemplo, para somar os pontos $P(6, 19)$ e $(9, 16)$, pertencentes à curva $E_{23}(1, 1)$ descrita na Figura \ref{fig:curva_exemplo}, basta substituir os valores \(x_P = 6\), \(y_P = 19\), \(x_Q = 9\), \(y_Q = 16\), \(a = 1\) e \(p = 23\) nas Eqs. \ref{x_result}
