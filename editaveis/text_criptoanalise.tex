...
e chamamos \(x\) como logaritmo discreto elíptico de \(Q\) em relação a \(P\). \cite{Hoffstein:2008} Encontrar o valor de \(x\) neste contexto exige muito poder e tempo de processamento, sendo algo computacionamente caro de se realizar. Um valor muito grande de \(x\) inviabiliza análises de força bruta.
